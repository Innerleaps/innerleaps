/**
 * De G van Google, als inline SVG.
 *
 * Stond eerst alleen in de footer. Nu het logo ook bij de afspraakplanner
 * staat, is het één bestand, zodat de twee niet uit elkaar kunnen gaan lopen.
 */
