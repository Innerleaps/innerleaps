              ...
              {steps.map((step, index) => {
                ...
                return (
                  <div key={index} className="relative">
                    <div className="bg-white rounded-xl p-4 md:p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                      <div className="flex items-start space-x-4 md:space-x-6">
                        <div className={`w-10 h-10 md:w-12 md:h-12 ${step.color} text-white rounded-lg flex items-center justify-center flex-shrink-0`}>
                          <IconComponent className="h-5 w-5 md:h-6 md:w-6" />
                        </div>
                        <div className="flex-1 min-w-0">
                          <h3 className="text-lg md:text-xl font-semibold text-brand-gray-dark mb-2 md:mb-4 leading-tight">
                            {step.title}
                          </h3>
                    ...
                    {index < steps.length - 1 && (
                      <div className="flex justify-center my-3 md:my-4">
                        <ArrowRight className="h-5 w-5 md:h-6 md:w-6 text-brand-blue transform rotate-90" />
                      </div>
                    )}
                  </div>
                );
