...
import { Calendar, CheckCircle, Target, TrendingUp, ArrowRight } from 'lucide-react';
...
const ProcessSection = () => {
  const steps = [
    ...
    {
      icon: Target,
      title: "Maatwerk Programmavoorstel",
      description: "Op basis van uw specifieke behoeften ontwikkelen we een aangepast programma met duidelijke doelen en tijdlijn",
    ...
    {
      icon: TrendingUp,
      title: "Resultaatmeting & Evaluatie",
              ...
              return (
                <div key={index} className="relative">
                  <div className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 h-full">
                    ...
                    <p className="text-brand-gray-medium text-sm leading-relaxed mb-4">
                      {step.description}
                    </p>
                    {step.cta && (
                      <Button 
                        variant="outline" 
                        size="sm"
                        className="border-2 border-brand-blue text-brand-blue hover:bg-brand-blue hover:text-white font-medium px-4 py-2 rounded-lg text-sm transition-all duration-300 w-full"
