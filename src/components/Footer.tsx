      ...
      <div className="container-custom">
        <div className={`grid grid-cols-1 ${showNavigation ? 'md:grid-cols-3' : 'md:grid-cols-2'} gap-8`}>
          <div>
            ...
            <p className="text-gray-300 leading-relaxed">Wetenschappelijk bewezen weerbaarheidstraining: Medewerkers worden productiever, gelukkiger en kunnen beter samenwerken.</p>
          </div>
          <div>
