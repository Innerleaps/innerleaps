...
import trainingImage from "@/assets/training_voor_betere_prestatie_minder_stress_en_lager_verzuim.webp";
import trainingImageEn from "@/assets/braintraining_for_optimal_performance.webp";
