...
const ProgramOverviewSection = () => {
  const features = [{
    ...
    icon: Sliders,
    title: "Opbouw",
    description: "Systematische opbouw van automatische patronen herkennen naar bewust handelen en integratie in het dagelijks leven."
  }, {
    icon: Users,
    title: "Veilige setting",
    description: "Deelnemers houden controle.  Ze reageren op vragen van de trainer met het opsteken van handen.  Persoonlijke toelichting is optioneel."
  }, {
    icon: Target,
  ...
  return <section className="section-padding bg-white">
      <div className="container-custom space-y-12">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto">
          ...
          return <div key={index} className="bg-white p-8 rounded-xl space-y-4 text-center">
