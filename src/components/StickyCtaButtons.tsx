  ...
  return (
    <>
      <div className="fixed bottom-4 sm:bottom-6 right-4 sm:right-6 z-40 flex flex-col gap-2 sm:gap-3 max-w-[calc(100vw-2rem)] sm:max-w-none">
        ...
        <Button 
          variant="outline"
          className="border-2 border-brand-blue text-brand-blue font-semibold py-3 sm:py-5 px-4 sm:px-10 rounded-lg text-base sm:text-lg transition-all duration-300 bg-white shadow-lg hover:shadow-xl transform hover:-translate-y-1 whitespace-nowrap"
