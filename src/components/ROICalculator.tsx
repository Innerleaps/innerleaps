              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid md:grid-cols-3 gap-6">
                  <div className="space-y-2">
                    ...
                    <Input id="naam" type="text" value={formData.naam} onChange={e => handleInputChange('naam', e.target.value)} className="bg-white border-gray-300 text-brand-gray-dark placeholder-[rgb(51,65,85)]" placeholder="Je volledige naam" required />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="email" type="email" value={formData.email} onChange={e => handleInputChange('email', e.target.value)} className="bg-white border-gray-300 text-brand-gray-dark placeholder-[rgb(51,65,85)]" placeholder="je.email@bedrijf.nl" required />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="bedrijfsnaam" type="text" value={formData.bedrijfsnaam} onChange={e => handleInputChange('bedrijfsnaam', e.target.value)} className="bg-white border-gray-300 text-brand-gray-dark placeholder-[rgb(51,65,85)]" placeholder="Je bedrijfsnaam" required />
                  </div>
                </div>
