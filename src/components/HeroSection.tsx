      ...
      >
        ...
        <div className="container-custom relative z-10 py-12 lg:py-20">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div className="space-y-6 lg:space-y-8 animate-fade-in">
              <div className="space-y-6">
                ...
                <div 
                  className="inline-flex items-center text-blue-200 px-4 py-2 rounded-full text-base md:text-lg font-medium"
                ...
                <h1 
                  className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-snug font-heading"
                  style={{ textShadow: '0 2px 8px rgba(0,0,0,0.5)' }}
                >
                ...
                <p 
                  className="text-xl sm:text-2xl md:text-3xl text-blue-100 leading-relaxed"
                  style={{ textShadow: '0 2px 8px rgba(0,0,0,0.5)' }}
                >
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button
                  size="lg"
                  className="w-full sm:w-auto bg-brand-orange hover:bg-brand-orange text-white hover:text-white font-semibold py-4 px-6 lg:px-8 rounded-lg text-lg lg:text-xl shadow-xl"
              ...
              <div className="flex justify-center pt-6 lg:pt-8">
                <div className="text-center">
                  <div 
                    className="text-2xl sm:text-3xl md:text-4xl font-bold text-brand-orange"
                    style={{ textShadow: '0 2px 8px rgba(0,0,0,0.5)' }}
                  >
                    40+ jaar
                  </div>
            ...
            <div className="relative animate-scale-in">
              <div className="rounded-2xl p-6 lg:p-8 max-w-md mx-auto">
                <div className="space-y-6">
                  <div className="text-center">
                    <h3 
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between p-3 lg:p-4">
                      ...
                      <span 
                        className="text-brand-orange font-bold text-lg lg:text-xl"
                        style={{ textShadow: '0 2px 8px rgba(0,0,0,0.5)' }}
                      >
                        -70%
                      </span>
          ...
          <div className="mt-12 lg:mt-16">
            <p 
              className="text-center text-blue-200 text-lg mb-6"
              style={{ textShadow: '0 2px 8px rgba(0,0,0,0.5)' }}
            >
              ...
              <div className="flex gap-8 animate-marquee">
                {logos.map((logo, index) => (
                  <img
                    ...
                    src={logo.src}
                    alt={logo.alt}
                    className="h-12 object-contain flex-shrink-0 grayscale opacity-70 hover:grayscale-0 hover:opacity-100 transition-all"
                  />
                ))}
              </div>
