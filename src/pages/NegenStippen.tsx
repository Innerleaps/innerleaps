        ...
        <div className="relative z-10 w-full section-padding">
          <div className="container-custom">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white text-center mb-12">
              ...
              <span className="text-brand-orange">afleiding</span> jouw{" "}
              <span className="text-brand-orange">focus</span> beïnvloedt
            </h1>
            ...
            <div className="grid md:grid-cols-2 gap-8 lg:gap-12 max-w-6xl mx-auto">
              ...
              <div className="bg-white/90 backdrop-blur-sm rounded-lg p-6 lg:p-8 space-y-6">
                <h2 className="text-2xl md:text-3xl font-bold text-brand-purple">
                  Stel je het volgende voor
                </h2>
                
                <p className="text-base md:text-lg text-brand-gray-medium leading-relaxed">
                  Je zit in een sollicitatiegesprek. Niet alleen, er zijn 3 andere kandidaten. 
                  Jullie zitten in de drukke bedrijfskantine. Om jullie heen lopen mensen, klinkt 
                  bestek, gesprekken, een koffiemachine die stomt.
                </p>
                ...
                <div className="border-l-4 border-brand-orange pl-4 py-3 space-y-3">
                  <p className="text-base md:text-lg text-brand-gray-medium italic">
                    "Ik wil kijken of jullie scherp zijn, creatief met oplossingen kunnen komen 
                    en snel kunnen werken. Daarom wil ik dat jullie dit raadsel oplossen."
                  </p>
                  <p className="text-base md:text-lg text-brand-gray-medium italic">
            ...
            <div className="flex flex-col items-center mt-12 lg:mt-16">
              <p className="text-white text-lg md:text-xl font-semibold mb-4">
                Lees hieronder wat er is gebeurd
              </p>
