        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button variant="secondary-on-blue" className="text-lg px-8 py-3 font-semibold rounded-lg" onClick={() => window.open('https://calendar.app.google/ZimMXqBKdvgv92g6A', '_blank')}>
