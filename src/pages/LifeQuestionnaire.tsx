        ...
        <div className="bg-card rounded-lg shadow-lg p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Accordion type="single" collapsible value={openAccordion} onValueChange={setOpenAccordion} className="space-y-4">
              {questions.map((question, index) => <AccordionItem key={index} value={`question-${index}`} className="border rounded-lg px-4">
                  ...
                  <AccordionContent className="pt-4">
                    ...
                    <RadioGroup value={answers[index]?.toString()} onValueChange={value => handleAnswerChange(index, value)}>
                      {options.map(option => <div key={option.value} className="flex items-center space-x-2 mb-2">
            ...
            <div className="flex justify-center pt-6">
              <Button type="submit" size="lg" disabled={answeredCount < questions.length || isSubmitting} className="w-full sm:w-auto">
